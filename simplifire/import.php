...
if(!empty($_FILES['file']['name']))
{
 ...
 SET organized = @column1, name = @column2,  start = @column3, end = @column4, role = @column5, institute = @column6, duration = @column7, url = @column8, type = @column9, level = @column10, proof = @column11
 ';
